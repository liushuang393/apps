...
**目的**: testing-kit v0.3.0 上に LAMS 用 project marker / profile / app.toml / app-owned-runtime を固定する。
**成功条件**:
...
**成功条件**:
- `helpers/auth.ts` が login/register + `lams-auth` zustand persist 注入
...
- [`docs/testing/lams-improvement-backlog.md`](docs/testing/lams-improvement-backlog.md) … LAMS 本体改善
