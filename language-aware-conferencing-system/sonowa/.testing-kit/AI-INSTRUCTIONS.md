...
Kit reference: `.venv-testing-kit/testing_kit`
...
If the public command is not installed, read `.venv-testing-kit/testing_kit/skills/testing-kit/SKILL.md`
and `.venv-testing-kit/testing_kit/docs/00-AI-ENTRY.md` directly.
...
1. Inventory every project and module from source
...
2. Publish the product to local Docker before E2E
...
3. Collect runtime and browser discovery evidence
...
4. Prove every business pattern
...
5. Repair only inside the declared authority boundary
...
6. Run repeatable project certification
