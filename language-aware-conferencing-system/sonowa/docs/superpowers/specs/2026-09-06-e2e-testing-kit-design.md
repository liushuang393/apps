...
Integrate testing-kit v0.3.0 (installed-kit) with Sonowa so the default path is:
...
| Sonowa backlog | `docs/testing/sonowa-improvement-backlog.md` |
| Reports | `docs/testing/report/` |

## Decision

- **Approach B**: strengthen kit contracts; Sonowa owns domain deltas only.
