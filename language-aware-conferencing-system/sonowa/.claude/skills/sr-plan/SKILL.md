...
<!-- sr-managed v5.3.0 -->
<!-- sr-context-profile {"base_common":["contract.md","method-router.md","artifact-map.md","approval-gate.md"],"entrypoint":"sr-plan","phase":"PLAN","workflow":"basic-plan.md"} -->
...
7. Read `.agents/core/workflows/basic-plan.md`.
8. Run only the **PLAN** workflow view. Do not execute another phase in this invocation.
