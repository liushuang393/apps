...
// in triprize_mobile/test/features/auth/presentation/providers/auth_provider_test.dart.
...
import 'package:triprize_mobile/core/network/auth_interceptor.dart' as _i6;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthInterceptor extends _i1.Mock implements _i6.AuthInterceptor {
  MockAuthInterceptor() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> onRequest(
