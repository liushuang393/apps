...
export class VoiceTranslateCore {
    ...
    initElements(): void {
        ...
        this.elements.vadSensitivity = document.getElementById('vadSensitivity') as HTMLSelectElement;
        ...
        this.elements.clearOutputBtn = document.getElementById('clearOutputBtn') as HTMLButtonElement;
    ...
    notify(_title: string, _message: string, _type: 'success' | 'error' | 'warning' | 'info'): void {
        // Part 5 で実装
    }
