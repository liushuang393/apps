 ...
 * ストレージキー
 */
export type StorageKey = 'openai_api_key' | 'source_lang' | 'target_lang' | 'voice_type' | 'audio_source_type' | 'vadEnabled' | 'noiseReduction' | 'echoCancellation' | 'autoGainControl' | 'showInputTranscript' | 'showOutputTranscript' | 'audioOutputEnabled' | 'inputAudioOutputEnabled';
/**
 * ストレージアダプター
 */
...
//# sourceMappingURL=ICoreTypes.d.ts.map